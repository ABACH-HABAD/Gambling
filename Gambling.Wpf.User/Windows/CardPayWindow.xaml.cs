...
public partial class PayWindow : Window
{
    ...
    private async void PayButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (_cardValidation.CardValidation(card, out string error))
        {
            ...
            {
                if (await _cardPayService.AddToBalanceAsync(AuthWindow.Instance.CurrentUser.Id, payCount, card, Promocode.Text != string.Empty || Promocode.Text != null ? Promocode.Text : null))
                {
